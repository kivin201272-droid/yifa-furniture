...
OFFICE_19_SKUS = [
    {
        ...
        "scene_props_present": True,
        "scene_props_included_in_sale": False,
        "carousel_images": [],
        "exact_price_row_text": "2715 Computer Desk $49.95",
    ...
    },
    {
        ...
        "scene_props_included_in_sale": False,
        "carousel_images": [],
        "exact_price_row_text": "2716 Computer Desk $59.95",
...
def update_manifest_and_audit():
    ...
    for item in OFFICE_19_SKUS:
        final_path = item['output_image']
        sha256_hex = hashlib.sha256(open(final_path, 'rb').read()).hexdigest()
        is_lifestyle = (item["sku"] in ["2715", "2716"])
        exact_price_rows = {
            "2715": "2715 Computer Desk $49.95",
            "2716": "2716 Computer Desk $59.95",
            "4500CA": "4500TAUPE/CA Computer Desk $39.95",
            "4500TAUPE": "4500TAUPE/CA Computer Desk $39.95",
            "2704WH": "2704WH/2704BK Computer Desk $19.95",
            "2704BK": "2704WH/2704BK Computer Desk $19.95",
            "2709": "2709 Computer Desk $49.95",
            "2714": "2714 Computer Desk with Glass $39.95",
            "2006GRAY": "2006GRAY Metal Cabinet $49.95",
            "2706": "2706 Computer Chair $55.00",
            "2707": "2707 Computer Chair $35.00",
            "2708BK": "2708BK Computer Chair $69.95",
            "2720BK-RD": "2720BK-RD 2721BK-GRAY Computer Chair $85.00",
            "2721BK-GRAY": "2720BK-RD 2721BK-GRAY Computer Chair $85.00",
            "2722RD": "2722RD/2723BK Computer Chair $109.95",
            "2723BK": "2722RD/2723BK Computer Chair $109.95",
            "2724BK": "2724BK/2724GRAY Computer Chair $99.95",
            "2724GRAY": "2724BK/2724GRAY Computer Chair $99.95",
            "2725BK": "2725BK Computer Chair $59.95"
        }
        m_entry = {
            "sku": item["sku"],
            ...
            "exact_price_row_text": exact_price_rows.get(item["sku"], ""),
            "staging_note_zh": item["staging_note_zh"],
            "staging_note_en": item["staging_note_en"],
            "source_is_lifestyle_scene": is_lifestyle,
            "scene_props_present": is_lifestyle,
            "scene_props_included_in_sale": False,
            "carousel_images": [],
